...
copy_files() {
    ...
    cp $HOME/Magisk/wokdir/lib/x86_64/libmagisk.so $HOME/Magisk/pc_magisk/magisk
    cp $HOME/Magisk/wokdir/lib/x86_64/libmagiskinit.so $HOME/Magisk/pc_magisk/magiskinit
    cp $HOME/Magisk/wokdir/lib/x86_64/libinit-ld.so $HOME/Magisk/pc_magisk/init-ld
