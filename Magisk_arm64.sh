...
copy_files() {
    ...
    cp $HOME/Magisk/wokdir/lib/arm64-v8a/libmagisk.so $HOME/Magisk/pc_magisk/magisk
    cp $HOME/Magisk/wokdir/lib/arm64-v8a/libmagiskinit.so $HOME/Magisk/pc_magisk/magiskinit
    cp $HOME/Magisk/wokdir/lib/arm64-v8a/libinit-ld.so $HOME/Magisk/pc_magisk/init-ld
